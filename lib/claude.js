...
Return a JSON object (no markdown fences, raw JSON only):
{
  ...
  "linkedin_cta": "A natural, non-salesy call to action for the LinkedIn post. Use comment-keyword pattern ('Comment audit and I'll send it') or value-first offer. NOT 'DM me' or 'Link in bio'.",
  "x_cta": "A natural CTA for the thread's last tweet. Use 'Reply [keyword]' or 'Follow for more' pattern."
}`;
